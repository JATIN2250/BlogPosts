...
import { FiEye, FiEyeOff, FiX } from "react-icons/fi"; // FiX ko import karein

// 'onClose' prop receive karein, jise App.js se pass kiya gaya hai
const RegisterPage = ({ onClose }) => {
  ...
  return (
    // YEH SABSE IMPORTANT CHANGE HAI: Outer div ko modal jaisa banayein
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
      <div className="relative bg-white p-8 rounded-xl shadow-lg w-full max-w-md">
        
        {/* Close Button */}
        <button
          onClick={onClose} // onClose function ko call karein
